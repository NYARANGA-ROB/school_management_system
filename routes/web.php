...
Route::group(['middleware' => ['auth', 'teamSAT'], 'prefix' => 'support_team'], function(){
        Route::group(['prefix' => 'cbc'], function(){
            Route::get('/', 'SupportTeam\CbcController@index')->name('cbc.index');
            Route::post('/competencies', 'SupportTeam\CbcController@storeCompetency')->name('cbc.competency.store');
            Route::post('/assessments', 'SupportTeam\CbcController@recordAssessment')->name('cbc.assessment.store');
            Route::get('/export/{studentId}/{year}/{term}', 'SupportTeam\CbcController@exportCsv')->name('cbc.export.csv');
        });

        // Analytics and Risk Management Routes
        Route::group(['prefix' => 'analytics'], function(){
            Route::get('/', 'SupportTeam\AnalyticsController@index')->name('analytics.dashboard');
            Route::get('/risk-management', 'SupportTeam\AnalyticsController@riskManagement')->name('analytics.risk');
            Route::get('/student/{studentId}', 'SupportTeam\AnalyticsController@studentProfile')->name('analytics.student');
            Route::post('/calculate-risks', 'SupportTeam\AnalyticsController@calculateRisks')->name('analytics.calculate');
            Route::post('/interventions', 'SupportTeam\AnalyticsController@createIntervention')->name('analytics.intervention.create');
            Route::put('/interventions/{id}', 'SupportTeam\AnalyticsController@updateIntervention')->name('analytics.intervention.update');
            Route::post('/alerts', 'SupportTeam\AnalyticsController@createAlert')->name('analytics.alert.create');
            Route::put('/alerts/{id}', 'SupportTeam\AnalyticsController@updateAlert')->name('analytics.alert.update');
            Route::get('/export', 'SupportTeam\AnalyticsController@exportRiskData')->name('analytics.export');
            Route::get('/class-analytics', 'SupportTeam\AnalyticsController@getClassAnalytics')->name('analytics.class');
            Route::get('/recommendations', 'SupportTeam\AnalyticsController@getRecommendations')->name('analytics.recommendations');
            Route::get('/dashboard-data', 'SupportTeam\AnalyticsController@getDashboardData')->name('analytics.dashboard.data');
        });
});
