    ...
    <div class="sidebar-content">
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
				...
				<?php if(Qs::userIsTeamSAT()): ?>
				<li class="nav-item">
					<a href="<?php echo e(route('analytics.dashboard')); ?>" class="nav-link <?php echo e(in_array(Route::currentRouteName(), ['analytics.dashboard', 'analytics.risk', 'analytics.student']) ? 'active' : ''); ?>">
						<i class="icon-stats-bars2"></i> <span> Analytics</span>
					</a>
				</li>
				<?php endif; ?>
...
<?php /**PATH /home/schrodinger/Desktop/Ai Edu/lav_sms/resources/views/partials/menu.blade.php ENDPATH**/ ?>