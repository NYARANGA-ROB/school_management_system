...
<script src="<?php echo e(asset('global_assets/js/plugins/forms/wizards/steps.min.js')); ?>"></script>
<script src="<?php echo e(asset('global_assets/js/plugins/forms/styling/uniform.min.js')); ?>"></script>
<script src="<?php echo e(asset('global_assets/js/plugins/forms/inputs/inputmask.js')); ?>"></script>
<script src="<?php echo e(asset('global_assets/js/plugins/forms/validation/validate.min.js')); ?>"></script>
<script src="<?php echo e(asset('global_assets/js/plugins/extensions/cookie.js')); ?>"></script>


<script type="text/javascript" src="<?php echo e(asset('global_assets/js/plugins/notifications/sweet_alert2.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('global_assets/js/plugins/notifications/pnotify.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('global_assets/js/plugins/pickers/bootstrap-datepicker.min.js')); ?>"></script>
<script src="<?php echo e(asset('global_assets/js/plugins/pickers/pickadate/legacy.js')); ?>"></script>


<script src="<?php echo e(asset('global_assets/js/plugins/uploaders/fileinput/fileinput.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('global_assets/js/demo_pages/form_wizard.js')); ?>"></script>
...
<script src="<?php echo e(asset('global_assets/js/demo_pages/uploader_bootstrap.js')); ?>"></script>
<script src="<?php echo e(asset('global_assets/js/demo_pages/fullcalendar_basic.js')); ?>"></script>

<!-- /theme JS files -->

<script src=" <?php echo e(asset('assets/js/custom.js')); ?> "></script>

<?php echo $__env->make('partials.js.custom_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/schrodinger/Desktop/Ai Edu/lav_sms/resources/views/partials/inc_bottom.blade.php ENDPATH**/ ?>